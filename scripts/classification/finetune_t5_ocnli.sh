...
# CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune/results/t5_finetune_ocnli_lr0.000005_drop/"
CKPT_PATH="${WORKING_DIR}/results/t5_finetune_ocnli_lr${LR}_ga${GRAD_ACC}_ep${EPOCHS}/"

SAVE_PATH="${WORKING_DIR}/results/t5_finetune_ocnli_lr${LR}_ga${GRAD_ACC}_ep${EPOCHS}/"
