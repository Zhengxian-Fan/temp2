...
DATA_EXT=".json"
CACHE_PATH="/cache/"
DATA_PATH="/mnt/sfs_turbo/data/CLUE/tnews"
...
# CKPT_PATH="/mnt/sfs_turbo/enc-dec-pretrain/results/enc_dec_mt5_2021-4-19"
# CKPT_PATH="/mnt/sfs_turbo/enc-dec-pretrain/checkpoints/checkpoint-4-19"
# CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune-zzy/results/t5_finetune_tnews_lr0.000005const_fix2"
# CKPT_PATH="${WORKING_DIR}/results/t5_finetune_tnews_lr${LR}const_fix2_ga${GRAD_ACC}_ep${EPOCHS}/"
CKPT_PATH="/mnt/sfs_turbo/applications/enc-dec-pretrain/results/enc_dec_mt5_app_receipt_rs/rs_15_2/"

# SAVE_PATH="${WORKING_DIR}/results/t5_finetune_tnews_lr${LR}const_fix2_ga${GRAD_ACC}_ep${EPOCHS}/"
SAVE_PATH="${WORKING_DIR}/results/t5_finetune_tnews_lr${LR}const_fix2_ga${GRAD_ACC}_ep${EPOCHS}/"
