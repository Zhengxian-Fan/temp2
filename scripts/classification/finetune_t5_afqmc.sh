...
# CKPT_PATH="${WORKING_DIR}/results/t5_finetune_afqmc_lr0.000005const_bs32_new_drop/"

LR=$1
GRAD_ACC=$2
EPOCHS=$3

SAVE_PATH="${WORKING_DIR}/results/t5_finetune_afqmc_lr${LR}const_ga${GRAD_ACC}_ep${EPOCHS}/"
