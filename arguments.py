...
def add_model_config_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--wd', type=float, default=0.0,
                       help='weight decay')
...
def add_data_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--train-lang', type=str, default=None,
                        help='Language of the training set.')
    group.add_argument('--eval-lang', type=str, default=None,
                        help='A string of target languages separated by comma.')
    group.add_argument('--test-lang', type=str, default=None,
                        help='A string of target languages separated by comma.')
    group.add_argument('--prompt-path', type=str, default=None,
                        help='Path to prompt')
    group.add_argument('--tuning_type', type=str, default='prompt',
                        help='prompt/adapter/bias/full_model')   
